...
<main id="main" role="main">
  ...
  <?php if( get_theme_mod('iqra_education_slider_arrows', false) != '' || get_theme_mod('iqra_education_enable_disable_slider', false) != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod('iqra_education_slider_speed', 3000)); ?>"> 
                ...
                <?php if (get_theme_mod( 'iqra_education_slider_button',true) != '' || get_theme_mod( 'iqra_education_show_hide_slider_button',true) != ''){ ?>
                  <?php if( get_theme_mod('iqra_education_slider_button_text','READ MORE') != ''){ ?>
                    <div class ="readbutton">
                      <a href="<?php esc_url(the_permalink()); ?>"><?php echo esc_html(get_theme_mod('iqra_education_slider_button_text','READ MORE'));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('iqra_education_slider_button_text','READ MORE'));?></span></a>
                    </div>
                  <?php } ?>
                <?php } ?>
              </div>
        ...
        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
          ...
          <span class="screen-reader-text"><?php esc_attr_e( 'Previous','iqra-education' );?></span>
        </a>
              ...
              <div class="about-text">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    ...
                    <p><?php the_excerpt();  ?></p>
                    <div class ="aboutbtn">
                      <a href="<?php esc_url(the_permalink()); ?>"><?php esc_html_e('Know About Us','iqra-education'); ?><span class="screen-reader-text"><?php echo esc_html( 'Know About Us','iqra-education' );?></span></a>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <?php
