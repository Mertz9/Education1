...
<main id="main" role="main">
	<div class="container">
		<header role="banner" class="page-header">
			...
			<?php else : ?>
				<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'iqra-education' ); ?></h1>
			<?php endif; ?>
		</header>
		<div class="row">
			<?php
		    ...
		    if($iqra_education_layout_setting == 'Left Sidebar'){ ?>
				...
				<div class="col-lg-8 col-md-8">
					...
					if ( have_posts() ) :
						...
						<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'iqra-education' ); ?></p>
						<?php
							get_search_form();
